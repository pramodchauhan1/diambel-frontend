...
<body>
    ...
    <main style="padding-top:0" id="index_page" class="smooth_scroll_pages">
        ...
        <section class="banner-sec">
            ...
            <div class="bgDiamondImg">
                <img src="img/intro/str.png" class="str str1" alt="">
                <img src="img/intro/shapeImg.png" class="shapeImg" alt="">
                <img src="img/intro/str.png" class="str str2" alt="">
            </div>
            ...
            <div class="our_catalogue">
                <div class="container">
                    ...
                    <div class="tab-menu" data-scroll>
                        <ul>
                            <li><a href="javascript:void(0)" class="tab-a text_reg active-a"
                                    data-id="polished_diamonds">Polished
                                    Diamonds</a>
                            </li>
                                    ...
                                    <div class="our_catalogue_box border_r15">
                                        ...
                                        <div class="our_catalogue_desc pt_20">
                                            ...
                                            <h6 class="text_reg f_w_s arrow_box">1.10
                                                <span><a href=""><img src="img/home/circle_arrow.png"
                                                            alt="circle_arrow" /></a></span>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="solutions_diamonds_flex d_flex">
                        <div class="solutions_diamonds_left">
                            <img id="step1" class="imgSec border_r15 solution_main_img showing"
                                src="img/home/solutions_img.jpg" alt="solutions_img" />
                            <img id="step2" class="imgSec border_r15 solution_main_img "
                                src="img/home/solutions_img.jpg" alt="solutions_img" />
                            <img id="step3" class="imgSec border_r15 solution_main_img "
                                src="img/home/solutions_img.jpg" alt="solutions_img" />
                            <img id="step4" class="imgSec border_r15 solution_main_img "
                                src="img/home/solutions_img.jpg" alt="solutions_img" />

                            <img class="imgSec solutions_layer_one p_s" src="img/home/solutions_layer_one.png"
                                alt="solutions_img" />
                            <img class="imgSec solutions_layer_two p_s" src="img/home/solutions_layer_two.png"
                                alt="solutions_img" />
                            <img class="imgSec solutions_layer_three p_s" src="img/home/solutions_layer_three.png"
                                alt="solutions_img" />
                        </div>
                        <div class="solutions_diamonds_right">
                            <div class="faq_section">
                                <div class="faq_box ptb_20">
                                    <a href="javascript:void(0)" class="faq_title" step-name="step1">
                                ...
                                <div class="faq_box ptb_20">
                                    <a href="javascript:void(0)" class="faq_title" step-name="step2">
                                ...
                                <div class="faq_box ptb_20">
                                    <a href="javascript:void(0)" class="faq_title" step-name="step3">
                                ...
                                <div class="faq_box ptb_20">
                                    <a href="javascript:void(0)" class="faq_title" step-name="step4">
